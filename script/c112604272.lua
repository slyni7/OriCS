...
function cm.spcon1(e,tp,eg,ep,ev,re,r,rp)
	return rp==tp and re:IsHasType(EFFECT_TYPE_ACTIVATE) and (re:GetHandler():IsCode(112604270) or re:GetHandler():IsCode(112601198))
end
...
function cm.thfilter(c)
	return (c:IsSetCard(0xe90) or c:IsSetCard(0xe75)) and c:IsAbleToHand()
end
